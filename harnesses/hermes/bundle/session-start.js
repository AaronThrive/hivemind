...
// dist/src/hooks/hermes/session-start.js
var log7 = (msg) => log("hermes-session-start", msg);
...
async function createPlaceholder(api, table, sessionId, cwd, userName, orgName, workspaceId, pluginVersion) {
  await createPlaceholderSummary((sql) => api.query(sql), { table, sessionId, cwd, userName, orgName, workspaceId, agent: "hermes", pluginVersion });
}
async function main() {
